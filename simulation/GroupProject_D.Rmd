...
### e.
The estimate coefficient is 1.02, which changes a little bit
...
### b
z <- rbinom(100*200,1, expit(dat_copy_5$x))
...
summary(lmer_fit_5)
```
The new estimate for slope is 2.027.

### e
Ummm not sure how to answer this one?
The confidence interval is (2.026 + )

### f
The total sample size is 7606, based on number of observations.

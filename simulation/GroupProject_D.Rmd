...
### e
The 95% confidence interval is [`r round(as.data.frame(coef(summary(lmer_fit_5)))[2,1]-1.96*as.data.frame(coef(summary(lmer_fit_5)))[2,2],3)`,`r round(as.data.frame(coef(summary(lmer_fit_5)))[2,1]+1.96*as.data.frame(coef(summary(lmer_fit_5)))[2,2],3)`], which does not cover the "truth".  

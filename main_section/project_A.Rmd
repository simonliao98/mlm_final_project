 ...
 **Answer:**  We have that V_S = 280.68, V_C = 85.46, and V_E = 1146.8
  ...
  **Answer:** The fraction decrease for V_S, and V_E are `round((280.68-169.45)/280.68, 2)`, and `r round((1146.8-1064.96)/1146.8, 2)`, respectively. But for V_C it actually increased `r round((93.89-85.46)/85.46, 2)` fraction-wise.

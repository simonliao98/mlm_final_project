...
plot(zeta1, zeta0)
```
Overall, zeta0 and zeta1 are negative correlated. However, some odds points are positive correlated.

```{r}
# e
blups_fit2$schoolid$minority[3-abs(blups_fit2$schoolid$minority)>0]
```
## Question 4
### a
